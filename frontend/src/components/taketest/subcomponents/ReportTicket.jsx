...
export default function Rticket() {
  ...
  var TestObjectRemvelATER = { current: location?.state };
  ...
  return (
    <div className="container">
      <div className="card justify-self-center align-self-center">
            ...
            <table className="table">
              <tbody>
                ...
                <tr>
                  ...
                  <td>{backendData.current.dyslexia_boolean ? "Yes" : "No"}</td>
                </tr>
                <tr>
                  <th scope="row">Visual Agnosia</th>
                  <td>
                    {backendData.current.visual_agnosia_boolean ? "Yes" : "No"}
                  </td>
                </tr>
              </tbody>
            </table>
